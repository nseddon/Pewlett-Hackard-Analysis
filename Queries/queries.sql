...
-- Create new temp table for employee data.
...
-- List of department retirees for sales
SELECT ce.emp_no,
ce.first_name,
ce.last_name,
d.dept_name
...
-- List of department retirees for sales and development
SELECT ce.emp_no,
ce.first_name,
ce.last_name,
d.dept_name
INTO sales_and_dev_retire_info
FROM current_emp as ce
INNER JOIN dept_emp AS de
ON (ce.emp_no = de.emp_no)
INNER JOIN departments AS d
